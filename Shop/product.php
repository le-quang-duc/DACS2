            ...
            <div class="wrap-menu-desktop">
                <nav class="limiter-menu-desktop container">
                    ...
                    <div class="wrap-icon-header flex-w flex-r-m" id="menu">
                        ...
                        <a href="Login.php" class="m-3">Đăng nhập </a> | <a href="Register.php" class="ml-3"> Đăng
                            ký</a>
                    </div>
                </nav>
            </div>
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img src="<?php echo htmlspecialchars($row['Image_product']); ?>"
                                    alt="<?php echo htmlspecialchars($row['Name_product']); ?>">
                            </div>
                            <div class="block2-txt">
                                <a href="product-detail.php?id=<?php echo htmlspecialchars($row['id']); ?>"
                                    class="block2-name"><?php echo htmlspecialchars($row['Name_product']); ?></a>
                                <span class="block2-price"><?php echo number_format($row['Price_product'], 0, ',', '.'); ?>
                                    VNĐ</span>
                            </div>
                        </div>
                    </div>
