...
<head>
    ...
    <script src="codeJS/variable.js"></script>
    <style>
        .avatar {
            width: 40px;
            height: 40px;
...
<body class="animsition">
            ...
            <div class="wrap-menu-desktop">
                <nav class="limiter-menu-desktop container">
                    ...
                    <div class="wrap-icon-header flex-w flex-r-m" id="menu">
                        ...
                        <a href="Login.php" class="m-4">Đăng nhập </a> | <a href="Register.php" class="ml-4"> Đăng
                            ký</a>
                    </div>
                </nav>
            </div>
    ...
    <div class="wrap-header-cart js-panel-cart">
        ...
        <div class="header-cart flex-col-l p-l-65 p-r-25">
            ...
            <div class="header-cart-content flex-w js-pscroll">
                <ul class="header-cart-wrapitem w-full" id="cartModal">
                ...
                <div class="w-full">
                    <div class="header-cart-total w-full p-tb-40" id="totalModal">
                        Total: $75.00
                    </div>
        ...
        <div class="wrap-slick1">
            <div class="slick1">
                ...
                <div class="item-slick1"
                    style="background-image: url(images/Grey\ Minimalist\ Special\ Offer\ Banner\ Landscape.png);">
                    <div class="container h-full">
                        <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
                            <div class="layer-slick1 animated visible-false" data-appear="rotateInDownLeft"
                                data-delay="0">
                                <span class="ltext-101 cl2 respon2">
                                    Phụ Kiện Thời Trang 2024
                                </span>
                            </div>
    ...
    <!-- Banner -->
    <div class="sec-banner bg0 p-t-80 p-b-50" style="background: floralwhite">
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="https://tngfashion.vn/image/catalog/2021/menu_nu1.jpg" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="https://tngfashion.vn/image/catalog/2021/home_nam_1.jpg" alt="IMG-BANNER">
                ...
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    <!-- Block1 -->
                    <div class="block1 wrap-pic-w">
                        <img src="https://cafefcdn.com/203337114487263232/2022/5/10/photo-1-165218467392766313139.jpg"
                            width="300" height="240" alt="IMG-BANNER">
            ...
            <div class="flex-w flex-sb-m p-b-52">
                ...
                <div class="dis-none panel-search w-full p-t-10 p-b-15">
                    <div class="bor8 dis-flex p-l-15">
                        ...
                        <input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" id="searchProduct"
    ...
    <?php while ($row = mysqli_fetch_assoc($result)): ?>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
            <div class="card h-100">
                ...
                <img src="<?php echo htmlspecialchars($row['Image_product']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($row['Name_product']); ?>">
                ...
                <div class="card-body">
                    ...
                    <!-- Nút mua ngay -->
                    <a href="add_to_cart.php?id=<?php echo htmlspecialchars($row['id']); ?>" class="btn btn-primary"    >
                        Mua ngay
                    </a>
                </div>
            </div>
