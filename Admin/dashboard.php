...
<body>
    ...
    <div class="container mt-5">
        ...
        <ul class="nav nav-tabs">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#account">Quản lý tài khoản</a>
            </li>
            <li class="nav-item">
        ...
        <div class="tab-content mt-3">
            ...
            <div id="account" class="container tab-pane active"><br>
                ...
                <div class="form-group">
                    <input id="searchAccount" oninput="searchAccount()" class="form-control"
                        placeholder="Tìm kiếm tài khoản" style="max-width: 300px;">
                </div>
                <table class="table table-striped">
                    ...
                    <tbody id="accountList">
                        <?php
                        include __DIR__ . '/../config/db.php'; // Đường dẫn chính xác đến db.php
                        ?>
                        <?php
                        ...
                        //             <td>{$row['role']}</td>
                        //             <td><a href='EditAccount.php?id={$row['id']}' class='btn btn-warning'>Edit</a></td>
                        //             <td><a href='DeleteAccount.php?id={$row['id']}' class='btn btn-danger'>Delete</a></td>
                        //           </tr>";
                        // }
                        ?>
                    </tbody>
                ...
                <div class="modal-body">
                    <form action="Editproduct.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <small id="currentImage" class="form-text text-muted">Hình ảnh hiện tại: <img id="currentImagePreview" width="50" height="50"></small>
                        </div>
                        <div class="form-group">
